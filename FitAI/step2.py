...
# @function_tool
# def get_excercise_info(muscle_group:str)->str:
#     """get a list of excercises for a specific muscle group"""
#     excercise_data = {
#         "chest":[
#             "Push-ups : 3 sets of 10-15 reps",
#             "Becnch Press : # sets if 8-12 reps",
#             "Chest Flyes: 3 sets of 12-15 reps",
#             "Incline Pish-ups: 3 sets of 10-15 reps"
#         ],
#         "back":[
...
#         ]
#     }
# """GEt information from the user anut his details"""
...
def get_exercise_info(muscle_group: str) -> str:
    ...
    if muscle_group in exercise_data:# Check if the requested muscle group exists in our exercise database
        exercises = exercise_data[muscle_group] # Retrieve the list of exercises for the requested muscle group
        return json.dumps({#The return statement sends this JSON string back as the function's output
            "muscle_group": muscle_group, # Include the requested muscle group name in the response
            "exercises": exercises,# Include the retrieved list of exercises in the response
